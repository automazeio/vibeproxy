...
### New Features
- **Auggie Integration** - Added support for Auggie AI assistant integration
- **Cursor IDE Support** - Enhanced compatibility with Cursor IDE proxy requirements

### Enhanced
- **CLIProxyAPI Compatibility** - Improved protocol handling for better compatibility with auggie and cursor clients
- **Fork Maintenance** - Project forked and maintained by Koosha Paridehpour for extended IDE support

### Credits
- Based on [VibeProxy](https://github.com/automazeio/vibeproxy) by Automaze, Ltd.
- Fork maintained by Koosha Paridehpour with focus on auggie/cursor integration
